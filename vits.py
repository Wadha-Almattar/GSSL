...
default_cfgs = {
    ...
    'deit_tiny_patch16_224': _cfg(
        url='https://dl.fbaipublicfiles.com/deit/deit_tiny_patch16_224-b5f2ef4d.pth',
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, norm_layer=None, flatten=True):
        ...
        self.grid_size = (img_size[0] // patch_size[0], img_size[0] // patch_size[1])
...
def deit_small(pretrained=False, **kwargs):
    """ DeiT-Small model from original paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights fine-tuned from @ 224x224.
    """
    model_kwargs = dict(
    img_size=224,
    patch_size=16,
    ...
    **kwargs
    ...
    model = _create_vision_transformer('deit_small', pretrained=pretrained, **model_kwargs)
    return model
