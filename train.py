    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for step, train_data in progress:
            ...
            with torch.cuda.amp.autocast(True):
                ...
                # ss_loss: saliency segmentation loss
...
#  this conditional statement checks if it is the main process,
# if the current epoch is at a checkpoint interval,
# and if it is not the final epoch.
# If all these conditions are met, the checkpoint is saved 

# It determines whether the current epoch is at a checkpoint interval
# that should trigger the saving of the checkpoint.

#  defualt interval each 20 epochs 
...
def save_checkpoint(args, epoch, model, optimizer, scaler):
    ...
    # model.state_dict():
    # It represents the learnable parameters of the model.
    
    # optimizer.state_dict():
    # It stores information about the optimizer's state,
    # such as the current parameter values and optimization statistics.

    # scaler.state_dict():
    # This key-value pair is optional and only
    # present if a scaler object is provided.
...
#  » Saving the checkpoint dictionary 
