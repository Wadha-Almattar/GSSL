...
parser.add_argument('--saliency-model', type=str, default='fine_grained', help='saliency model (fine_grained / spectral_residual/ ObjectnessBING/ MotionSaliency)')
...
def saliency_detect(i, saliency_model, src_path, output_path, visualize_path):
    ...
    elif saliency_model == 'ObjectnessBING':
        saliency = cv.saliency.ObjectnessBING_create()
    elif saliency_model == 'MotionSaliency':
